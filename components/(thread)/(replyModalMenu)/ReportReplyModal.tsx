...
type Props = {
  reportReplyModalVisible: boolean
  setReportReplyModalVisible: React.Dispatch<React.SetStateAction<boolean>>,
...
const ReportReplyModal = ({reportReplyModalVisible, setReportReplyModalVisible, id, displayName}: Props) => {
  ...
  return (
    <Modal
      ...
      onRequestClose={closeReportReplyModal}
      style={{ height: "30%" }}
    >
      <View style={styles.modalContainer}>
        <View style={styles.modalContentContainer}>
        <TouchableOpacity style={styles.close} onPress={closeReportReplyModal}>
